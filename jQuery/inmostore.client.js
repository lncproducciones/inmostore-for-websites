(function($) {
     ...
     * @property {number} codigo - Código de la operación.
     * @property {string} newItemId - ID del nuevo elemento creado (GUID).
     * @property {number} affectedRows - Número de filas afectadas por la operación.
     ...
     * @property {number} elementoId - ID del elemento.
     * @property {number} padre - ID del elemento padre.
     ...
     * @property {number} status - Estado del elemento (0: Inactivo, 1: Activo).
     */

    /**
     * @typedef {object} Escena
     * @property {string} escenaId - ID de la escena (GUID).
     * @property {string} empresaId - ID de la empresa a la que pertenece la escena (GUID).
     * @property {number} modo - Tipo de escena (0: Inmueble, 1: Proyecto).
     * @property {string} objecto - ID del objeto asociado a la escena (GUID).
     ...
     * @property {number} status - Estado de la escena (0: Inactiva, 1: Activa).
     */

    /**
     * @typedef {object} EscenaPin
     * @property {string} pinId - ID del pin (GUID).
     * @property {string} empresaId - ID de la empresa a la que pertenece el pin (GUID).
     * @property {string} escenaId - ID de la escena a la que pertenece el pin (GUID).
     * @property {string} etiqueta - Texto a mostrar del pin.
     * @property {string} pitch.
     * @property {string} yaw.
     * @property {string} target - ID de la escena a la que apunta el hotspot (GUID).
     * @property {number} status - Estado del pin (0: Inactivo, 1: Activo).
     */

    /**
     * @typedef {object} Imagen
     * @property {string} imageId - ID de la imagen (GUID).
     * @property {string} empresaId - ID de la empresa a la que pertenece la imagen (GUID).
     * @property {number} modo - Modo de la imagen (0: Inmueble, 1: Proyecto).
     * @property {string} objectId - ID del objeto asociado a la imagen (GUID).
     ...
     * @property {number} status - Estado de la imagen (0: Inactiva, 1: Activa).
     */
    ...
    class Website {
        ...
        /**
         * @param {string} apiId - El ID de la API.
         * @param {string} apiKey - La clave de la API.
         */
        constructor(apiId, apiKey) {
            console.log("InmoStore for jQuery");
        ...
        /**
         * Realiza una llamada AJAX asíncrona usando jQuery.
         * @private
         * @param {string} url - La URL de la API.
         * @returns {object} Una promesa que se resuelve con la respuesta de la API.
         */
        _fetch(url) {
            const self = this;
        ...
        async init() {
            if (!this.apiKey) {
                ...
                // En un contexto de jQuery, no redirigir automáticamente, solo registrar el error
                // window.location.href = "https://www.lncproducciones.com/web";
            }
            else {
                try {
                    const response = await this._fetch(`${this.apiRoot}sys/version/${this.apiKey}`);
                    this.apiVersion = response.Resultado;
                    $('head').append(`<meta name="generator" content="InmoStore by Portal Services v.${this.apiVersion}">`);
         ...
         * @param {number} id - ID del elemento a consultar.
         * @returns {getElementoResult} Detalle del elemento consultado.
         */
        getElemento(id) {
            return this._fetch(`${this.apiRoot}elementos/get/${id}/${this.apiKey}`);
        }

        /**
         * Obtiene el detalle de la empresa.
         * @param {string} id - ID de la empresa a consultar.
         * @returns {getEmpresaResult} Detalle de la empresa consultada.
         */
        getEmpresa(id) {
            return this._fetch(`${this.apiRoot}empresas/get/${id}/${this.apiKey}`);
        }

        /**
         * Obtiene la lista de escenas activas de un objeto.
         * @param {string} empresaId - ID de la empresa a consultar.
         * @param {number} modo - Modo de la escena (0: Inmueble, 1: Proyecto).
         * @param {string} objectId - ID del objeto asociado a la escena.
         * @returns {listEscenasResult} Lista de escenas activas del objeto.
         */
        listEscenas(empresaId, modo, objectId) {
            return this._fetch(`${this.apiRoot}escenas/active/${empresaId}/${modo}/${objectId}/${this.apiKey}`);
        }

        /**
         * Obtiene la lista de pins de la escena actual.
         * @param {string} escenaId - ID de la escena a consultar.
         * @returns {listEscenasPinsResult} Lista de pins de la escena consultada.
         */
        listEscenaPins(escenaId) {
            return this._fetch(`${this.apiRoot}pins/list/${escenaId}/${this.apiKey}`);
        }

        /**
         * Obtiene la URL de una imagen para embebder, basado en su id.
         * @param {string} imageId - ID de la imagen a consultar.
         ...
         * @param {number} modo - Modo de la imagen (0: Inmueble, 1: Proyecto).
         * @param {string} objectId - ID del objeto asociado a la imagen.
         * @returns {listImagenesResult} Lista de imágenes del objeto consultado.
         */
        listImagenes(modo, objectId) {
            return this._fetch(`${this.apiRoot}imagenes/list/${modo}/${objectId}/${this.apiKey}`);
        }

        /**
         * Obtiene la imagen de portada de un inmueble.
         * @param {string} inmuebleId - ID del inmueble a consultar.
         * @returns {getImagenPortadaResult} Imagen de portada del inmueble consultado.
         */
        getImagenPortada(inmuebleId) {
            return this._fetch(`${this.apiRoot}imagenes/portada/${inmuebleId}/${this.apiKey}`);
        }
        ...
        getInmueble(inmuebleId) {
            return this._fetch(`${this.apiRoot}inmuebles/get/${inmuebleId}/${this.apiKey}`);
        }

        /**
         * Obtiene el listado de inmuebles filtrados por empresa, tipo de inmueble, tipo de operación y ciudad.
         * @param {string} empresaId - ID de la empresa a consultar.
         * @param {number} tipoInmueble - Código del tipo de inmueble (ej. casa, apartamento).
         * @param {number} tipoOperacion - Código del tipo de operación (ej. venta, renta).
         * @param {number} ciudad - Código de la ciudad a consultar.
         * @returns {listInmueblesResult} Lista de inmuebles filtrados.
         */
        listInmueblesBy(empresaId, tipoInmueble, tipoOperacion, ciudad) {
            return this._fetch(`${this.apiRoot}inmuebles/listweb/${empresaId}/${tipoInmueble}/${tipoOperacion}/${ciudad}/${this.apiKey}`);
        }
        ...
        listTiposInmueble(empresaId) {
            return this._fetch(`${this.apiRoot}inmuebles/tiposInmueble/${empresaId}/${this.apiKey}`);
        }
        ...
        listTiposOperacion(empresaId) {
            return this._fetch(`${this.apiRoot}inmuebles/tiposOperacion/${empresaId}/${this.apiKey}`);
        }
        ...
        listCiudades(empresaId) {
            return this._fetch(`${this.apiRoot}inmuebles/ciudades/${empresaId}/${this.apiKey}`);
        }
        ...
        listInmueblesPortada(empresaId) {
            return this._fetch(`${this.apiRoot}inmuebles/portada/${empresaId}/${this.apiKey}`);
        }
        ...
        listInmueblesRecientes(empresaId) {
            return this._fetch(`${this.apiRoot}inmuebles/recientes/${empresaId}/${this.apiKey}`);
        }
        ...
        getInmuebleCaracteristicas(inmuebleId) {
            return this._fetch(`${this.apiRoot}caracteristicas/get/${inmuebleId}/${this.apiKey}`);
        }

        /**
         * Obtiene el listado de propiedades de un inmueble.
         * @param {string} inmuebleId - ID del inmueble a consultar.
         * @param {number} tipoPropiedad - Código del tipo de propiedad a consultar (0, 1).
        ...
        listPropiedadesInmueble(inmuebleId, tipoPropiedad) {
            return this._fetch(`${this.apiRoot}properties/list/${inmuebleId}/${tipoPropiedad}/${this.apiKey}`);
        }

        /**
         * Obtiene la información de un proyecto inmobiliario por su ID.
         * @param {string} proyectoId - ID del proyecto a consultar.
         * @returns {getProyectoResult} Detalle del proyecto consultado.
         */
        getProyecto(proyectoId) {
            return this._fetch(`${this.apiRoot}proyectos/get/${proyectoId}/${this.apiKey}`);
        }
        ...
        listProyectos(empresaId) {
            return this._fetch(`${this.apiRoot}proyectos/active/${empresaId}/${this.apiKey}`);
        }

        /**
         * Obtiene el ID del proyecto basado en su subdominio.
         * @param {string} subdomain - Subdominio del proyecto a consultar.
         * @returns {string} ID del proyecto asociado al subdominio.
         */
        getProyectoIdBySubdomain(subdomain) {
            return this._fetch(`${this.apiRoot}proyectos/pidsubdir/${subdomain}/${this.apiKey}`);
        }

        /**
         * Obtiene el detalle de un modelo de inmueble dentro de un proyecto.
         * @param {string} modeloId - ID del modelo a consultar.
         * @returns {getProyectoModeloResult} Detalle del modelo consultado.
         */
        getProyectoModelo(modeloId) {
            return this._fetch(`${this.apiRoot}modelos/get/${modeloId}/${this.apiKey}`);
        }
        ...
        listProyectoModelos(proyectoId) {
            return this._fetch(`${this.apiRoot}modelos/active/${proyectoId}/${this.apiKey}`);
        }
        ...
        getSetting(empresaId, clave) {
            return this._fetch(`${this.apiRoot}settings/get/${empresaId}/${clave}/${this.apiKey}`);
        }
    }

    // Exporta la clase para que pueda ser utilizada
    $.inmostore = Website;

})(jQuery);

// Suponiendo que pswebId y pswebKey están definidos
const inmostoreClient = new $.inmostore(window.pswebId, window.pswebKey);
inmostoreClient.init();
